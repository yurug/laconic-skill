...
if command -v python3 >/dev/null 2>&1; then
  ...
  echo "commands: ${BINDIR}/laconic-record, laconic-lint, laconic-index, laconic-console, laconic-candidates, laconic-bootstrap, laconic-review, laconic-review-web, laconic-apply-review"
else
